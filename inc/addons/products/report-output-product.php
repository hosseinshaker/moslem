<?php
$title_page = "گزارش خروجی محصولات";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['send'])) {
    ...
    // ساخت کوئری برای جستجو در جدول products_output
    $query = "SELECT * FROM products_output WHERE 1=1";
...
<div class="main-content">
     <div class="col-12">
        ...
        while ($row = $result->fetch_assoc()) {
            // واکشی اطلاعات محصول از جدول products_output با استفاده از JSON
                ...
                if ((!empty($productName) && in_array($product['productqr'], $productName)) || empty($productName)) {
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo  $row['exit_id'];  ?></td>
                                            <td><?php echo  $product['product_name'].' کد: '.$product['productqr']  ?></td>
